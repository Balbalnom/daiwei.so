    ...
    <div className="max-w-2xl">
      ...
      >
        <Balancer>
          ...
          致力于创造一个充满创造力的工作环境，同时鼓励团队创造影响世界的产品。
      ...
      >
        <SocialLink
          href="https://twitter.com/BalnomX"
          aria-label="twitter"
          platform="twitter"
        />
        {/* <SocialLink
        ...
        /> */}
        <SocialLink
          href="https://github.com/Balbalnom"
        ...
        <SocialLink
          href="/feed.xml"
          platform="rss"
          aria-label="RSS subscribe"
        />
        <SocialLink
          href="mailto:daiweiatwork@gmail.com"
          aria-label="email"
          platform="mail"
        />
      </motion.div>
